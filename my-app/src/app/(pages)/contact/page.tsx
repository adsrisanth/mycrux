              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 bg-white border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-black placeholder-gray-500"
                ...
                <div>
                  ...
                  <select
                    id="subject"
                    name="subject"
                    className="w-full px-4 py-3 bg-white border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-black"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="w-full px-4 py-3 bg-white border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-black placeholder-gray-500 resize-none"
                    placeholder="Tell us how we can help you..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-black border border-black cursor-pointer hover:bg-gray-800 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-white border border-black rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-black hover:text-gray-600 transition-colors duration-300 cursor-pointer"
                    >
                      admin@mycrux.com
                    </a>
                  </div>
                ...
                <div className="pt-6 border-t border-black">
                  <h3 className="text-lg font-medium text-black mb-4">Follow us</h3>
                  <div className="flex space-x-4">
                    {/* X (Twitter) */}
                    <a href="https://x.com/mycruxin?t=CzqDnOMbflOFfqhk4KRBJg&s=08" target='_blank' className="w-10 h-10 bg-white border-black border rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-300" title="Follow us on X">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                      </svg>
                    </a>
                    {/* Instagram */}
                    <a href="https://www.instagram.com/mycrux.in?igsh=MXBiY2J5Y2FmY2xuaw==" target='_blank' className="w-10 h-10 bg-white border-black border rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-300" title="Follow us on Instagram">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/company/mycruxin/" target='_blank' className="w-10 h-10 bg-white border-black border rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-300" title="Connect on LinkedIn">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                      </svg>
                    </a>                    
                    {/* Threads */}
                    <a href="https://www.threads.com/@mycrux.in" target='_blank' className="w-10 h-10 bg-white border-black border rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-300" title="Follow us on Threads">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
